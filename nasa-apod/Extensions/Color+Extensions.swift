...
extension Color {
    ...
    static let lightBackground = Color(hex: "EBE6FF")
    
    static let darkBackground = Color(hex: "5523B2")
...
struct AppBackgroundColor: View {
    ...
    var body: some View {
        (effectiveColorScheme == .dark ? Color.darkBackground : Color.lightBackground)
            .ignoresSafeArea()
